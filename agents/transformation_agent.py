...
class TransformationAgent:
    ...
    def __init__(self):
        ...
        self.description = (
            "Transforms data from various formats into a common structure"
        )
        self.capabilities = [
            "CSV processing",
            "Excel processing",
    ...
    def transform_data(self, file_info, validation_result):
        ...
        processing_time = base_time * complexity_factor.get(
            file_info["complexity"], 1.0
        )
        ...
        file_size = (
            ...
            * complexity_factor.get(file_info["complexity"], 1.0)
            * 1024
        )  # in bytes
        ...
        return {
            ...
            "transformation_steps": [
                ...
                (
                    ...
                    if "date" in file_info["filename"].lower()
                    else None
                ),
            ],
